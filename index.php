...
<head>
	...
	<meta charset="utf-8">
	<title>Hackea Tu Ciudad</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=no">

	<meta property="og:title" content="Hackea Tu Ciudad" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="http://hackeatuciudad.mx" />
	<meta property="og:image" content="" />

	<meta name="title" content="Hackea Tu Ciudad" />
	<meta name="author" content="Codeando M&eacute;xico" />
	<meta name="copyright" content="Hackea Tu Ciudad" />
	<meta name="Language" content="Spanish" />
	<meta name="apple-mobile-web-app-capable" content="yes" />
	<meta name="robots" content="all | index | follow" />
	<meta name="description" content="Hackea Tu Ciudad" />
	<meta name="keywords" content="Hackea Tu Ciudad" />
...
<body>
	<header class="container">
		<a href="#" class="logo">
			<img src="img/logo.svg" onclick="revealhome();" alt="Hackea Tu Ciudad">
		</a>
		<nav class="main">
			<ul class="cf u-full-width">
				<li><a href="#" rel="mty">Monterrey</a></li>
				<li><a href="#" rel="gdl">Guadalajara</a></li>
				<li><a href="#" rel="yourCity">Tu ciudad</a></li>
				<li><a href="#" rel="pitch">Registra tu pitch</a></li>
			</ul>
		</nav>
	</header>
	<div class="container content">
		...
		<section class="mty">
			...
			<nav class="tabs u-full-width">
				<ul class="cf u-full-width">
					...
					<li><a href="#">&iquest;C&oacute;mo llego?</a></li>
					<li><a href="#">FAQ</a></li>
				</ul>
			</nav>
			<section class="agenda">
				...
				<div class="block apink">
					<h4>Break / Networking</h4>
				</div>
				<div class="block main">
					<h4>Talleres simult&aacute;neos</h4>
					<ul class="">
						<li>Aprende a programar: YouthSpark <span class="dots">............................. </span> 10:00 A.M.</li>
						<li>&iquest;C&oacute;mo estructurar una idea de producto tecnol&oacute;gico?<span class="dots"> ......... </span> 10:00 A.M.</li>
						<li>Visualizaciones de datos en productos de tecnolog&iacute;a c&iacute;vica .. 10:00 A.M.</li>
						<li>Pitchea tu idea c&iacute;vica <span class="dots"> ......................................</span> 12:00 P.M.</li>
					</ul>
				</div>
			</section>
		...
		<section class="gdl">
			<h2>Guadalajara</h2>
			<h3 class="sub"><a href="#">9 de abril</a> | <a href="https://www.facebook.com/CUAAD/" target="_blank">@CUAAD, UDG. Auditorio de Posgrado (Modas)</a></h3>
			...
			<section class="agenda">
				...
				<div class="block apink">
					<h4>Break / Networking................................12:05-12:20 P.M.</h4>
				</div>
	...
	<footer>
		<div class="container">
			<img src="img/logos.png" alt="Logos patrocinadores">
		</div>
		<div class="clear h100px"></div>
	</footer>
	...
	$(function(){
		...
		$('nav.main a').click(function(e){
			...
			$('.content section.active').removeClass('active').fadeOut('fast', function(){
				$('section.'+section).fadeIn('fast').addClass('active');
			});
		});
	});
